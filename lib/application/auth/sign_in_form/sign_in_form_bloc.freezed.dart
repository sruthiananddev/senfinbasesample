...
mixin _$SignInFormEvent {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(dynamic emailStr) emailChanged,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(dynamic emailStr)? emailChanged,
...
class __$$EmailChangedCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$EmailChanged(
      freezed == emailStr ? _value.emailStr! : emailStr,
    ));
  }
}
...
abstract class EmailChanged implements SignInFormEvent {
  const factory EmailChanged(final dynamic emailStr) = _$EmailChanged;

  dynamic get emailStr;
  @JsonKey(ignore: true)
  _$$EmailChangedCopyWith<_$EmailChanged> get copyWith =>
      throw _privateConstructorUsedError;
}
...
abstract class PasswordChanged implements SignInFormEvent {
  const factory PasswordChanged(final dynamic passwordStr) = _$PasswordChanged;
