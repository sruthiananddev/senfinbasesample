...
class _$_User implements _User {
  _$_User(
      ...
      this.profile,
      this.redirect,
      @JsonKey(name: 'site_notification') this.siteNotification});
  ...
  @override
  String toString() {
    return 'User(status: $status, profile: $profile, redirect: $redirect, siteNotification: $siteNotification)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, status, profile, redirect, siteNotification);
...
abstract class _User implements User {
  factory _User(
          ...
          final Profile? profile,
          final String? redirect,
          @JsonKey(name: 'site_notification') final int? siteNotification}) =
      _$_User;
